...
public:
     ...
     */
    EgoSplitting(const Graph &G, bool parallelEgoNetEvaluation, const CommunityDetectionAlgorithm &clusterAlgo);
     ...
     */
    EgoSplitting(const Graph &G, bool parallelEgoNetEvaluation, const CommunityDetectionAlgorithm &localClusterAlgo,
...
private:
    ...
    std::unique_ptr<CommunityDetectionAlgorithm> localClusteringAlgo, globalClusteringAlgo;
