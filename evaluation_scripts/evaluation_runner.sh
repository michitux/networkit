...
#    python3 evaluation.py -g ${graph} -p "../output/QTM2/${graph_set}/temp_${scenario}/" -s ${scenario} -r ${seed} &
#  done
#  wait
#done < "$input"
#python3 means.py -p "../output/QTM2/${graph_set}/temp_${scenario}/"
...
do
  for seed in $seeds; do
    python3 evaluation.py -g ${graph} -p "../output/QTM2/biological${limit}/temp_${scenario}/" -s ${scenario} -r ${seed} &
  done
  wait
done < "$input"
python3 means.py -p "../output/QTM2/biological${limit}/temp_${scenario}/"
